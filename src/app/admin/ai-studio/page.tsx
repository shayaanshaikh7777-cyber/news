        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs font-bold">
              <div>
                <label className="block text-gray-700 mb-1">स्थान संदर्भ (Location):</label>
                <input
                  type="text"
                  value={location}
          ...
          {result ? (
            ...
            <div className="bg-white p-12 rounded-2xl border border-dashed border-gray-300 text-center flex flex-col items-center justify-center text-gray-400 space-y-3">
              ...
              <p className="text-xs max-w-sm">
                'संपूर्ण बातमी तयार करा' वर क्लिक केल्यास संपूर्ण मसुदा, सोशल कॅप्शन्स आणि SEO सह तयार होईल.
              </p>
            </div>
          )}
        </div>
